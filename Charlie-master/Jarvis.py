...
def wishme():
    ...
    speak("I am Jarvis.. Please tell me how can I help you, Sumit")
...
#-------------------Shutdown computer-------------
    if 'shutdown' in query or 'shutdown options' in query:
        ...
        if "yes" in shut:
            ...
            while True:
                speak("Please enter your choice, Sumit")
                option = input("choice >")
                if "1"== option:
        ...
        while True:
            ...
            try:
                if "quit"in folder:
                    ...
                    break
                elif 'mitsu' in folder:
                    path = 'C:\\important files\\Sumit Sharma'
                    os.startfile(path)
                    break
                elif 'sumit'in folder:
                    path = 'C:\\important files\\important'
                    os.startfile(path)
                    break
                    ...
                    speak("Please enter the correct folder, Sumit")
            except:
                speak("Please enter the correct folder, Sumit")
#-------------------------Pycharm---------------------------
    if 'code' in query:
        speak("Sure Sumit, I am opening the pycharm")
...
#------------------------Wikipedia------------------------------------
    if 'wikipedia' in query:
        ...
        while True:
            ...
            try:
                if "quit" in s:
                    speak("Ok Sumit, I quit the wikipediar. Any task for me Sumit.")
                    break
                else:
                    print("Searching...")
                ...
                speak("Please check your internet connection, Sumit")
#--------------------------youtube------------------------------------
    if 'youtube' in query:
        ...
        while True:
            try:
                ...
                if 'yes'in answer:
                    ...
                    speak("Okay Sumit, I quit the youtube.")
                    break
                else:
